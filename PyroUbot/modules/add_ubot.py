...
async def _(client, callback_query):
    ...
    try:
        phone = await bot.ask(
            user_id,
            (
                "<blockquote><b>📱 NOMOR TELEGRAM ANDA</b></blockquote>\n\n"
                "<blockquote><b>✮ Silakan masukkan nomor telepon Telegram Anda dengan format kode negara.</b></blockquote>\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━\n\n"
                "<blockquote><b>📝 CONTOH FORMAT:</b>\n"
                "🇮🇩 Indonesia: <code>+628xxxxxxxxx</code>\n"
                "🇺🇸 USA: <code>+1xxxxxxxxxx</code>\n"
                "🇬🇧 UK: <code>+44xxxxxxxxxx</code>\n"
                "🇲🇾 Malaysia: <code>+60xxxxxxxxx</code></blockquote>\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━\n\n"
                "<blockquote><b>💡 TIPS:</b>\n"
                "• Pastikan nomor aktif & bisa menerima OTP\n"
                "• Gunakan /cancel untuk membatalkan\n\n"
                "<b>⏰ Timeout: 5 menit</b></blockquote>"
            ),
            timeout=300,
        )
    except asyncio.TimeoutError:
        return await bot.send_message(user_id, "<blockquote><b>⏰ TIMEOUT!\n\n❌ Waktu habis! Proses dibatalkan otomatis.\n\n💡 Gunakan /start untuk memulai ulang.</b></blockquote>")
    ...
    get_otp = await bot.send_message(user_id, "<blockquote><b>📤 Mengirim kode OTP...\n\n⏳ Mohon tunggu sebentar...</b></blockquote>")
    ...
    try:
        ...
        otp = await bot.ask(
            user_id,
            (
                "<blockquote><b>📱 KODE OTP TELEGRAM</b></blockquote>\n\n"
                "<blockquote><b>✮ Silakan periksa kode OTP dari akun resmi Telegram.</b></blockquote>\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━\n\n"
                "<blockquote><b>📝 FORMAT PENGIRIMAN:</b>\n"
                "✮ Jika kode OTP adalah <code>12345</code>\n"
                "✮ Tolong <u><b>tambahkan spasi</b></u> seperti ini:\n"
                "   👉 <code>1 2 3 4 5</code></blockquote>\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━\n\n"
                "<blockquote><b>💡 TIPS:</b>\n"
                "• Copy kode dari Telegram\n"
                "• Paste di sini dengan spasi\n"
    ...
    try:
        ...
        try:
            two_step_code = await bot.ask(
                user_id,
                (
                    "<blockquote><b>🔐 VERIFIKASI DUA LANGKAH</b></blockquote>\n\n"
                    "<blockquote><b>✮ Akun Anda telah mengaktifkan verifikasi dua langkah (2FA).</b></blockquote>\n\n"
                    "━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    "<blockquote><b>🔑 Silakan kirimkan password 2FA Anda.</b></blockquote>\n\n"
                    "━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    "<blockquote><b>💡 TIPS:</b>\n"
...
@PY.ADMIN
async def _(client, callback_query):
    if not ubot._ubot or len(ubot._ubot) == 0:
        buttons = [
            [InlineKeyboardButton("⦪ ᴋᴇᴍʙᴀʟɪ ⦫", callback_data=f"home {callback_query.from_user.id}")],
        ]
        return await bot.send_message(
            callback_query.from_user.id,
            "<blockquote><b>📊 List Userbot\n\n❌ Belum ada userbot yang aktif saat ini.\n\n💡 Silakan buat userbot terlebih dahulu!</b></blockquote>",
            reply_markup=InlineKeyboardMarkup(buttons),
        )
